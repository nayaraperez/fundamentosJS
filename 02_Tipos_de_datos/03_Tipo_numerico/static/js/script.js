...
//Tipos de satos numericos
//let-->Palabra clave para crear una variable
//1.- declaracion de numeros(creacion variacion numerica)
let edad = 31;
let temperatura = -5;
let precio = 19990;
let pi = 3.1416;
...
let division = 10 / 2; //5
let modulo = 10 % 3; //1 resto de la divicion %
let potencia = 2 ** 3; //8
...
let numero = 10;
numero++; //11-->incrementa 1 a la variante ++
numero--;//9-->Decrementa 1 a la variables  --
...
//numeros aliatorios
let aliatorio = Math.random(); //entre 0 y 1
let dado = Math.floor(Math.random ()*6) +1;
console.log(`tirar dados: ${dado}`);
//9.-Conparaciones numericas
let a =10;
let b = 5;
console.log(a > b); //true
console.log(a < b) //farse
console.log (a === 10);// true( es estricta igualdad)
console.log (b === 3);//Farse
